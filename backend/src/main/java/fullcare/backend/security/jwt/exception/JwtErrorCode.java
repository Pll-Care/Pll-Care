...
public enum JwtErrorCode implements ErrorCode {
    ...
    // ! refresh token 도 만료되어 재 로그인이 필요한 경우 -> jwt_002로 처리?
    ...
    INVALID_REFRESH_TOKEN("JWT_008", HttpStatus.UNAUTHORIZED, "유효하지 않은 토큰입니다"),
    EXPIRED_REFRESH_TOKEN("JWT_009", HttpStatus.UNAUTHORIZED, "만료된 JWT 리프레시 토큰입니다.");
