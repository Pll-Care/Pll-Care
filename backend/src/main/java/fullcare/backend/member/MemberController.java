...
public class MemberController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "프로필 이미지 조회 실패", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class)))
    })
    @GetMapping("/image")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "아이디만 조회 실패", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class)))
    })
    @GetMapping("/onlyid")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "이미지만 조회 실패", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class)))
    })
