...
public enum ScheduleErrorCode implements ErrorCode {
    ...
    CATEGORY_NOT_MODIFY("SCHEDULE_004", HttpStatus.BAD_REQUEST, "일정 카테고리는 변경할 수 없습니다."),
    INVALID_DATE_RANGE("SCHEDULE_005", HttpStatus.BAD_REQUEST, "시작일정과 종료일정이 올바르지 않습니다."),
    INVALID_SCHEDULE_DATE_RANGE("SCHEDULE_006", HttpStatus.BAD_REQUEST, "일정이 프로젝트 일정을 벗어났습니다."),

    UNAUTHORIZED_ACCESS("SCHEDULE_007", HttpStatus.FORBIDDEN, "해당 일정에 접근 권한이 없습니다."),
    UNAUTHORIZED_DELETE("SCHEDULE_008", HttpStatus.FORBIDDEN, "해당 일정에 대한 삭제 권한이 없습니다."),
    UNAUTHORIZED_MODIFY("SCHEDULE_009", HttpStatus.FORBIDDEN, "해당 일정에 대한 수정 권한이 없습니다."),
    ...
    INVALID_ACTION("SCHEDULE_014", HttpStatus.FORBIDDEN, "완료된 프로젝트에서는 해당 기능을 사용할 수 없습니다."),


    SCHEDULE_UNCOMPLETED("SCHEDULE_015", HttpStatus.FORBIDDEN, "해당 일정이 완료되지 않았습니다."),
    SCHEDULE_COMPLETED("SCHEDULE_016", HttpStatus.FORBIDDEN, "해당 일정이 이미 완료되었습니다.");
