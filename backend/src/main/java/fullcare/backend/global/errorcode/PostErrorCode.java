...
public enum PostErrorCode implements ErrorCode {
    ...
    INVALID_RECRUITMENT_DATE_RANGE("POST_003", HttpStatus.BAD_REQUEST, "모집기간이 프로젝트 일정을 벗어났습니다."),
    ...
    INVALID_ACCESS("POST_008", HttpStatus.FORBIDDEN, "완료된 프로젝트 모집글에 접근 권한이 없습니다."), // ? unused
    ...
    RECRUITMENT_NOT_FOUND("RECRUITMENT_001", HttpStatus.NOT_FOUND, "모집 중인 포지션이 아닙니다."),
