...
public enum PostErrorCode implements ErrorCode {
    ...
    INVALID_RECRUITMENT_POSITION("RECRUITMENT_002", HttpStatus.BAD_REQUEST, "모집 포지션 정보가 올바르지 않습니다."),
    INVALID_RECRUITMENT_AMOUNT("RECRUITMENT_003", HttpStatus.BAD_REQUEST, "모집인원 정보가 올바르지 않습니다."),
    RECRUITMENT_COMPLETED("RECRUITMENT_004", HttpStatus.FORBIDDEN, "이미 모집이 완료된 포지션입니다.");
