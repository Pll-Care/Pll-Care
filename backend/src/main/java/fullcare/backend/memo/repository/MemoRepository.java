...
public interface MemoRepository extends JpaRepository<Memo, Long> {
    ...
    Page<Memo> findMemoListByProjectId(@Param("projectId") Long projectId, Pageable pageable);
    ...
    Optional<MemoDetailResponse> findMemoDetailDto(@Param("projectMemberId") Long projectMemberId, @Param("memoId") Long memoId);
