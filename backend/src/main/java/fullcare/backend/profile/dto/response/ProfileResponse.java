...
public class ProfileResponse {
    ...
    @Builder
    public ProfileResponse(String bio, Contact contact, RecruitPosition recruitPosition, List<String> techStack, List<ProjectExperienceResponseDto> projectExperiences, boolean myProfile) {
        this.bio = bio;
