...
const getAverageEvaluationList = () => {
  ...
  const averageEvaluationList = sumOfEvaluationList.map(
    (item) =>
    ...
    <div className="evaluation-management">
      <div className="evaluation-management-ranking-wrapper">
        <ShowEvaluationRanking
          getAverageEvaluationList={getAverageEvaluationList}
        />
        <EvaluationRanking
          getSortedAverageEvaluationList={getSortedAverageEvaluationList}
        />
      </div>
